...
fsyn = 4120.0e6*2; % [Hz] Valon synthesizer + frequency doubler
...
f22to11 = fARP*1e6;%8144e6;                           %[Hz] energy difference between |22> and |11> at B0
fDDS0 = fsyn - f22to11;                     %[Hz] center DDS RF frequency, final output frequency from mixer is fsyn - fDDS;
if fDDS0 < 0
    error('f22to11 needs to be smaller than fsyn! ');
end

...
tFwdTrip = 3412e-3;%[s]1077ms for 200mm,2551ms for 971.25mm, 3412ms for966.25
...
TOFRb=7e-3;%[s]TOFRb or TOFK needs to be bigger than texpcam/2+tid=105.6us
TOFK=20e-3;%[s]
...
tRetTrip = 3409e-3;%1077ms for 200mm,
s.addStep(@TrackTransfer,tRetTrip);

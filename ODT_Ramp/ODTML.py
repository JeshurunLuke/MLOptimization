...
class Utils():
    ...
    def write(self, count, params):
        ...
        io.savemat(writeFileLoc,{'count': count, 'newTODTPWR': params[0], 'RatioF':params[1:len(params)] })
...
def main():
    ...
    #[newTODTPWR, RatioF, RatioF, RatioF, RatioF]
    init = [1.2,0.9,0.70, 0.5, 0.4]
    minB= [0.4, 0.0, 0.0, 0.0, 0.0]
    maxB = [3.2, 1.0, 1.0, 1.0, 1.0]
    clear()

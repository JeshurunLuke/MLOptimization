...
fcut = cell2mat(struct2cell(load('param.mat', 'fcut'))).*1e6;

tTotal = cell2mat(struct2cell(load('param.mat', 'tTotal')));
tau = tTotal/length(fcut)*ones(1, length(fcut));

amp = cell2mat(struct2cell(load('param.mat', 'amp')));
A = cell2mat(struct2cell(load('param.mat', 'A')));
